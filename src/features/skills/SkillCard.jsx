function SkillCard({image , hover_image , alt}){
    ...
    return (
        <div className="w-[330px] h-[140px] max-lg:w-[280px] max-md:w-[200px] max-sm:w-[280px] bg-white rounded-2xl flex justify-center items-center hover:bg-light-green transition-colors [&_img]:w-16 cursor-pointer group max-md:[&_img]:w-14 ">
